          ...
          <p className="text-xl text-white/80 max-w-xl mx-auto mt-4">
            ...
            <div className="relative w-full max-w-md lg:w-2/5 lg:max-w-none h-96 lg:h-[28rem] rounded-2xl overflow-hidden shadow-2xl">
              <Image
                ...
                alt="Advanced eye care services"
                fill
                priority
                quality={90}
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="bg-white rounded-2xl p-8 border border-[var(--color-border)] hover:shadow-xl hover:-translate-y-1 transition-all duration-300 animate-fade-up group">
              ...
              <Link href="/services/cataract-surgery" className="block group/title">
                <h3 className="font-cormorant text-2xl font-semibold text-[var(--color-ink)] mt-5 group-hover/title:text-[var(--color-primary)] transition-colors cursor-pointer">
                  Cataract Surgery
                </h3>
              </Link>
            ...
            <div className="bg-white rounded-2xl p-8 border border-[var(--color-border)] hover:shadow-xl hover:-translate-y-1 transition-all duration-300 animate-fade-up group">
              ...
              <Link href="/services/minimally-invasive-glaucoma-surgery" className="block group/title">
                <h3 className="font-cormorant text-2xl font-semibold text-[var(--color-ink)] mt-5 group-hover/title:text-[var(--color-primary)] transition-colors cursor-pointer">
                  Minimally Invasive Glaucoma Surgery
                </h3>
              </Link>
            ...
            <div className="bg-white rounded-2xl p-8 border border-[var(--color-border)] hover:shadow-xl hover:-translate-y-1 transition-all duration-300 animate-fade-up group">
              ...
              <Link href="/services/dry-eye-treatment" className="block group/title">
                <h3 className="font-cormorant text-2xl font-semibold text-[var(--color-ink)] mt-5 group-hover/title:text-[var(--color-primary)] transition-colors cursor-pointer">
                  Dry Eye Treatment
                </h3>
              </Link>
            ...
            <div className="bg-white rounded-2xl p-8 border border-[var(--color-border)] hover:shadow-xl hover:-translate-y-1 transition-all duration-300 animate-fade-up group">
              ...
              <Link href="/services/diabetic-eye-exams" className="block group/title">
                <h3 className="font-cormorant text-2xl font-semibold text-[var(--color-ink)] mt-5 group-hover/title:text-[var(--color-primary)] transition-colors cursor-pointer">
                  Diabetic Eye Exams
                </h3>
              </Link>
