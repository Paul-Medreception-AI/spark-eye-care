          ...
          <div className="grid lg:grid-cols-2 gap-16">
            ...
            <div className="space-y-8">
              ...
              <div className="bg-white rounded-2xl p-8 border border-[var(--color-border)] animate-fade-up">
                ...
                <a href="tel:+15123771076" className="text-2xl font-semibold text-[var(--color-primary)] hover:text-[var(--color-dark)] transition-colors block mb-2 tracking-tight">(512) 377-1076</a>
