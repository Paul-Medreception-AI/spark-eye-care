...
export const metadata: Metadata = {
  title: 'Nuclear Sclerotic Cataracts Treatment in Kyle | Spark Eye Care',
  description: 'Expert nuclear sclerotic cataracts treatment in Kyle. Board-certified ophthalmologists providing advanced cataract surgery and personalized care. Schedule your consultation today.',
  keywords: 'nuclear sclerotic cataracts treatment Kyle, cataract surgery Kyle, nuclear cataracts Kyle, eye doctor Kyle, ophthalmologist Kyle',
  openGraph: {
    title: 'Nuclear Sclerotic Cataracts Treatment in Kyle | Spark Eye Care',
    description: 'Expert nuclear sclerotic cataracts treatment in Kyle. Advanced surgical solutions and compassionate care.',
    url: 'https://www.sparkeyetx.com/conditions/nuclear-sclerotic-cataracts',
  }
}

export default function NuclearScleroticCataractsPage() {
  return (
      ...
      <section className="bg-gradient-to-br from-[var(--color-dark)] to-[var(--color-primary)] text-white">
        <div className="max-w-7xl mx-auto px-6 py-16 lg:py-24">
          <div className="flex flex-col lg:flex-row gap-8 lg:gap-10 items-center">
            ...
            <span className="mx-2">›</span>
            <span>Nuclear Sclerotic Cataracts</span>
          </nav>
            ...
            <div>
              ...
              <div className="space-y-4">
                <div className="flex gap-3">
                  ...
                  <div>
                    <p className="font-semibold text-[var(--color-ink)]">Progressive Blurred Vision</p>
                    <p className="text-[var(--color-muted)]">Gradual cloudiness that makes objects appear hazy, especially in the center of your visual field.</p>
                  </div>
                </div>
                <div className="flex gap-3">
                  <svg stroke="currentColor" strokeWidth={1.5} fill="none" viewBox="0 0 24 24" className="w-6 h-6 text-[var(--color-primary)] flex-shrink-0 mt-1">
                  ...
                  <div>
                    <p className="font-semibold text-[var(--color-ink)]">Yellowing of Vision</p>
                    <p className="text-[var(--color-muted)]">Colors appear faded, washed out, or have a yellow or brown tint, affecting your ability to distinguish hues.</p>
                  </div>
                </div>
                <div className="flex gap-3">
                  <svg stroke="currentColor" strokeWidth={1.5} fill="none" viewBox="0 0 24 24" className="w-6 h-6 text-[var(--color-primary)] flex-shrink-0 mt-1">
                  ...
                  <div>
                    ...
                    <p className="text-[var(--color-muted)]">Increased problems seeing in dim lighting or at night, with halos around lights and glare from headlights.</p>
                  </div>
                </div>
                <div className="flex gap-3">
                  <svg stroke="currentColor" strokeWidth={1.5} fill="none" viewBox="0 0 24 24" className="w-6 h-6 text-[var(--color-primary)] flex-shrink-0 mt-1">
                  ...
                  <div>
                    ...
                    <p className="text-[var(--color-muted)]">Difficulty distinguishing objects from their background, making reading and facial recognition challenging.</p>
                  </div>
                </div>
                <div className="flex gap-3">
                  <svg stroke="currentColor" strokeWidth={1.5} fill="none" viewBox="0 0 24 24" className="w-6 h-6 text-[var(--color-primary)] flex-shrink-0 mt-1">
                  ...
                  <div>
                    <p className="font-semibold text-[var(--color-ink)]">Increased Nearsightedness</p>
                    <p className="text-[var(--color-muted)]">Temporary improvement in near vision (second sight) followed by progressive worsening of distance vision.</p>
                  </div>
                </div>
                <div className="flex gap-3">
                  <svg stroke="currentColor" strokeWidth={1.5} fill="none" viewBox="0 0 24 24" className="w-6 h-6 text-[var(--color-primary)] flex-shrink-0 mt-1">
                  ...
                  <div>
                    <p className="font-semibold text-[var(--color-ink)]">Light Sensitivity and Glare</p>
                    <p className="text-[var(--color-muted)]">Discomfort in bright sunlight or with indoor lighting, causing squinting and visual discomfort.</p>
                  </div>
                </div>
                <div className="flex gap-3">
                  <svg stroke="currentColor" strokeWidth={1.5} fill="none" viewBox="0 0 24 24" className="w-6 h-6 text-[var(--color-primary)] flex-shrink-0 mt-1">
                  ...
                  <div>
                    ...
                    <p className="text-[var(--color-muted)]">Need for more frequent updates to eyeglass or contact lens prescriptions with diminishing improvement.</p>
                  </div>
                </div>
              </div>
            </div>
            <div>
              ...
              <div className="space-y-4">
                <div className="flex gap-3">
                  ...
                  <div>
                    <p className="font-semibold text-[var(--color-ink)]">Reading Difficulties</p>
                    <p className="text-[var(--color-muted)]">Struggling to read books, newspapers, or digital screens even with adequate lighting and corrective lenses.</p>
                  </div>
                </div>
                <div className="flex gap-3">
                  <svg stroke="currentColor" strokeWidth={1.5} fill="none" viewBox="0 0 24 24" className="w-6 h-6 text-[var(--color-primary)] flex-shrink-0 mt-1">
                  ...
                  <div>
                    <p className="font-semibold text-[var(--color-ink)]">Driving Challenges</p>
                    <p className="text-[var(--color-muted)]">Unsafe or uncomfortable driving, especially at night or in poor weather due to glare and reduced clarity.</p>
                  </div>
                </div>
                <div className="flex gap-3">
                  <svg stroke="currentColor" strokeWidth={1.5} fill="none" viewBox="0 0 24 24" className="w-6 h-6 text-[var(--color-primary)] flex-shrink-0 mt-1">
                  ...
                  <div>
                    ...
                    <p className="text-[var(--color-muted)]">Increasing reliance on others for transportation, shopping, and daily tasks due to declining vision.</p>
                  </div>
                </div>
                <div className="flex gap-3">
                  <svg stroke="currentColor" strokeWidth={1.5} fill="none" viewBox="0 0 24 24" className="w-6 h-6 text-[var(--color-primary)] flex-shrink-0 mt-1">
                  ...
                  <div>
                    ...
                    <p className="text-[var(--color-muted)]">Avoiding activities and social situations due to embarrassment or frustration with vision problems.</p>
                  </div>
                </div>
                <div className="flex gap-3">
                  <svg stroke="currentColor" strokeWidth={1.5} fill="none" viewBox="0 0 24 24" className="w-6 h-6 text-[var(--color-primary)] flex-shrink-0 mt-1">
                  ...
                  <div>
                    ...
                    <p className="text-[var(--color-muted)]">Higher likelihood of trips, falls, and accidents due to impaired depth perception and contrast sensitivity.</p>
                  </div>
                </div>
                <div className="flex gap-3">
                  <svg stroke="currentColor" strokeWidth={1.5} fill="none" viewBox="0 0 24 24" className="w-6 h-6 text-[var(--color-primary)] flex-shrink-0 mt-1">
                  ...
                  <div>
                    ...
                    <p className="text-[var(--color-muted)]">Emotional distress related to progressive vision loss and uncertainty about future independence.</p>
                  </div>
                </div>
                <div className="flex gap-3">
                  <svg stroke="currentColor" strokeWidth={1.5} fill="none" viewBox="0 0 24 24" className="w-6 h-6 text-[var(--color-primary)] flex-shrink-0 mt-1">
                  ...
                  <div>
                    ...
                    <p className="text-[var(--color-muted)]">Overall reduction in enjoyment of hobbies, activities, and daily experiences due to impaired vision.</p>
                  </div>
                </div>
              </div>
            </div>
        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="grid md:grid-cols-3 gap-8 mb-12">
            ...
            <div className="bg-white p-8 rounded-lg shadow-sm hover:shadow-md transition-shadow animate-fade-up">
              ...
              <h3 className="text-2xl font-light mb-3" style={{ fontFamily: 'var(--font-cormorant)' }}>Advanced Surgical Treatment</h3>
              <p className="text-[var(--color-muted)] leading-relaxed">
            ...
            <div className="bg-white p-8 rounded-lg shadow-sm hover:shadow-md transition-shadow animate-fade-up">
              ...
              <h3 className="text-2xl font-light mb-3" style={{ fontFamily: 'var(--font-cormorant)' }}>Postoperative Care & Recovery</h3>
              <p className="text-[var(--color-muted)] leading-relaxed">
        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div className="text-center animate-fade-up">
              ...
              <h3 className="text-xl font-semibold mb-2 text-[var(--color-ink)]">Personalized Treatment Plans</h3>
              <p className="text-[var(--color-muted)]">
            ...
            <div className="text-center animate-fade-up">
              ...
              <h3 className="text-xl font-semibold mb-2 text-[var(--color-ink)]">Cutting-Edge Technology</h3>
              <p className="text-[var(--color-muted)]">
            ...
            <div className="text-center animate-fade-up">
              ...
              <h3 className="text-xl font-semibold mb-2 text-[var(--color-ink)]">Compassionate, Patient-Centered Care</h3>
              <p className="text-[var(--color-muted)]">
        ...
        <div className="max-w-4xl mx-auto px-6">
          ...
          <div className="space-y-12">
            ...
            <div className="flex gap-6">
              ...
              <div>
                <h3 className="text-2xl font-light mb-2" style={{ fontFamily: 'var(--font-cormorant)' }}>Surgery Day (Weeks 2-4)</h3>
                <p className="text-[var(--color-muted)] leading-relaxed">
            ...
            <div className="flex gap-6">
              ...
              <div>
                <h3 className="text-2xl font-light mb-2" style={{ fontFamily: 'var(--font-cormorant)' }}>Long-Term Vision Care</h3>
                <p className="text-[var(--color-muted)] leading-relaxed">
          ...
          <div className="space-y-4">
            <details className="group border border-[var(--color-border)] rounded-lg overflow-hidden">
              <summary className="flex justify-between items-center cursor-pointer p-6 hover:bg-[var(--color-cream)] transition-colors">
                <span className="font-semibold text-lg text-[var(--color-ink)]">How long does cataract surgery take and what is the recovery time?</span>
            ...
            <details className="group border border-[var(--color-border)] rounded-lg overflow-hidden">
              <summary className="flex justify-between items-center cursor-pointer p-6 hover:bg-[var(--color-cream)] transition-colors">
                <span className="font-semibold text-lg text-[var(--color-ink)]">Is cataract surgery safe and what are the risks?</span>
                <svg className="w-5 h-5 text-[var(--color-primary)] transition-transform group-open:rotate-180" fill="none" stroke="currentColor" strokeWidth={2} viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" d="M19 9l-7 7-7-7" />
                </svg>
              </summary>
            ...
            <details className="group border border-[var(--color-border)] rounded-lg overflow-hidden">
              <summary className="flex justify-between items-center cursor-pointer p-6 hover:bg-[var(--color-cream)] transition-colors">
                <span className="font-semibold text-lg text-[var(--color-ink)]">When is the right time to have cataract surgery?</span>
                <svg className="w-5 h-5 text-[var(--color-primary)] transition-transform group-open:rotate-180" fill="none" stroke="currentColor" strokeWidth={2} viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" d="M19 9l-7 7-7-7" />
                </svg>
              </summary>
      ...
      <section className="bg-[var(--color-cream)] py-16">
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <a href="/conditions/cortical-cataracts" className="bg-white p-6 rounded-lg shadow-sm hover:shadow-md transition-shadow group">
            ...
            <a href="/conditions/posterior-subcapsular-cataracts" className="bg-white p-6 rounded-lg shadow-sm hover:shadow-md transition-shadow group">
              <h4 className="text-xl font-semibold mb-2 text-[var(--color-ink)] group-hover:text-[var(--color-primary)] transition-colors">
      ...
      <section className="bg-gradient-to-br from-[var(--color-dark)] to-[var(--color-primary)] py-24 text-white text-center">
        <div className="max-w-4xl mx-auto px-6">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <a href="/contact" className="inline-block bg-white text-[var(--color-primary)] px-8 py-4 rounded-lg font-semibold hover:bg-[var(--color-cream)] transition-colors">
              Schedule Your Consultation
            </a>
            <a href="/conditions" className="inline-block bg-transparent border-2 border-white text-white px-8 py-4 rounded-lg font-semibold hover:bg-white hover:text-[var(--color-primary)] transition-colors">
              View All Conditions
            </a>
          </div>
        </div>
