          ...
          <div className="bg-white rounded-2xl p-8 flex gap-6 items-start shadow-sm">
            ...
            <div>
              ...
              <p className="text-[var(--color-muted)] text-sm leading-relaxed">
                Board-certified providers specializing in ophthalmology and surgical eye care, dedicated to delivering evidence-based patient education and exceptional eye care to our community.
              </p>
            </div>
          </div>
        </div>
