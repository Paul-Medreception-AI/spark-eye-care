        ...
        <div className="bg-[var(--color-cream)] rounded-2xl p-8 max-w-3xl mx-auto my-12 flex gap-6 items-start animate-fade-up">
          ...
          <div>
            ...
            <p className="text-[var(--color-muted)] leading-relaxed">
              Board-certified providers specializing in ophthalmology and surgical eye care, committed to delivering evidence-based patient education and comprehensive eye care to our community.
            </p>
          </div>
        </div>
      </article>
