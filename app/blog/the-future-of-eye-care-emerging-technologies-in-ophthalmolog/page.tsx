      ...
      <div className="max-w-3xl mx-auto px-6 my-12">
        <div className="bg-[var(--color-cream)] rounded-2xl p-8 flex gap-6 items-start animate-fade-up">
          ...
          <div>
            ...
            <p className="text-[var(--color-muted)] leading-relaxed">Board-certified providers specializing in ophthalmology and surgical eye care, dedicated to delivering evidence-based, compassionate care to every patient.</p>
          </div>
        </div>
      </div>
