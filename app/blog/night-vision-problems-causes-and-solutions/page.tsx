        ...
        <div className="max-w-3xl mx-auto px-6">
          <div className="bg-[var(--color-cream)] rounded-2xl p-8 flex gap-6 items-start">
            ...
            <div>
              ...
              <p className="text-[var(--color-muted)] leading-relaxed">Board-certified providers specializing in ophthalmology and surgical eye care with a commitment to evidence-based patient education and comprehensive eye care.</p>
            </div>
          </div>
        </div>
      </div>
