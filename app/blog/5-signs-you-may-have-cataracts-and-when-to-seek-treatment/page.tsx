    ...
    <main className="min-h-screen bg-white">
      <section className="bg-gradient-to-br from-[var(--color-dark)] to-[var(--color-primary)] py-20 text-white">
        <div className="max-w-4xl mx-auto px-6">
          ...
          <h1 className="text-5xl font-light leading-tight text-center font-serif">
            5 Signs You May Have Cataracts and When to Seek Treatment
          </h1>
      ...
      <article className="bg-white py-20">
        <div className="max-w-3xl mx-auto px-6">
          ...
          <h2 className="text-3xl text-[var(--color-ink)] mt-12 mb-4 font-serif">
          ...
          <blockquote className="bg-[var(--color-cream)] border-l-4 border-[var(--color-primary)] p-6 my-8 text-[var(--color-ink)] italic text-xl font-serif">
          ...
          <ul className="list-disc list-inside text-[var(--color-ink)] leading-loose text-base mb-8 space-y-2">
            <li>Age over 60 (risk increases significantly after 70)</li>
            <li>Family history of cataracts</li>
            <li>Diabetes or metabolic disorders</li>
            <li>Prolonged exposure to UV radiation without eye protection</li>
          ...
          <ul className="list-disc list-inside text-[var(--color-ink)] leading-loose text-base mb-8 space-y-2">
            <li>Vision problems interfere with daily activities like reading, driving, or work</li>
            <li>You no longer feel safe driving, especially at night</li>
            <li>Glare prevents you from doing things you enjoy</li>
            <li>Vision changes affect your independence or quality of life</li>
            <li>Your eye doctor recommends evaluation based on the progression of your cataracts</li>
          </ul>
          ...
          <ul className="list-disc list-inside text-[var(--color-ink)] leading-loose text-base mb-8 space-y-2">
            <li>Test your visual acuity at various distances</li>
            <li>Examine the lens of your eye using specialized equipment</li>
            <li>Assess how cataracts are affecting your daily vision</li>
            <li>Measure your eye to determine the appropriate lens implant if surgery is recommended</li>
            <li>Discuss your symptoms, concerns, and treatment options</li>
          </ul>
          ...
          <div className="bg-[var(--color-cream)] border border-[var(--color-border)] rounded-lg p-8 my-12">
            <h3 className="text-2xl text-[var(--color-ink)] mb-4 font-serif">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <a
                href="/contact"
                className="inline-block bg-[var(--color-primary)] text-white px-8 py-3 rounded-md hover:bg-[var(--color-dark)] transition-colors text-center"
              >
      ...
      <section className="bg-[var(--color-cream)] py-16">
        <div className="max-w-4xl mx-auto px-6">
          <div className="text-center mb-8">
            <h2 className="text-3xl text-[var(--color-ink)] mb-4 font-serif">Related Articles</h2>
            <p className="text-[var(--color-muted)]">Continue learning about eye health and vision care</p>
          </div>
          <div className="grid md:grid-cols-3 gap-8">
            <a href="/blog/what-to-expect-during-comprehensive-eye-exam" className="bg-white p-6 rounded-lg border border-[var(--color-border)] hover:shadow-lg transition-shadow">
              <div className="text-xs uppercase tracking-widest text-[var(--color-primary)] mb-2">Eye Health</div>
              <h3 className="text-xl text-[var(--color-ink)] mb-2 font-serif">What to Expect During a Comprehensive Eye Exam</h3>
              <p className="text-[var(--color-muted)] text-sm">Learn about the tests and technology used to assess your vision and eye health.</p>
            </a>
            <a href="/blog/protecting-your-eyes-from-uv-damage" className="bg-white p-6 rounded-lg border border-[var(--color-border)] hover:shadow-lg transition-shadow">
              <div className="text-xs uppercase tracking-widest text-[var(--color-primary)] mb-2">Prevention</div>
              <h3 className="text-xl text-[var(--color-ink)] mb-2 font-serif">Protecting Your Eyes from UV Damage</h3>
              <p className="text-[var(--color-muted)] text-sm">Discover why UV protection matters and how to keep your eyes safe year-round.</p>
            </a>
            <a href="/blog/understanding-age-related-eye-conditions" className="bg-white p-6 rounded-lg border border-[var(--color-border)] hover:shadow-lg transition-shadow">
              <div className="text-xs uppercase tracking-widest text-[var(--color-primary)] mb-2">Aging Eyes</div>
              <h3 className="text-xl text-[var(--color-ink)] mb-2 font-serif">Understanding Age-Related Eye Conditions</h3>
              <p className="text-[var(--color-muted)] text-sm">From cataracts to macular degeneration, learn what to watch for as you age.</p>
            </a>
          </div>
        </div>
      </section>
