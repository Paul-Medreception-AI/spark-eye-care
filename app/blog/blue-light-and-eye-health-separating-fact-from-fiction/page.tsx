        ...
        <div className="bg-[var(--color-cream)] rounded-2xl p-8 max-w-3xl mx-auto my-12 animate-fade-up">
          <div className="flex gap-6 items-start">
            ...
            <div>
              ...
              <p className="text-[var(--color-muted)] leading-relaxed">Board-certified providers specializing in ophthalmology and surgical eye care, dedicated to providing evidence-based care and patient education.</p>
            </div>
          </div>
        </div>
      </article>
