      ...
      <div className="max-w-3xl mx-auto px-6 my-12">
        <div className="bg-[var(--color-cream)] rounded-2xl p-8 flex gap-6 items-start">
          ...
          <div>
            ...
            <p className="text-[var(--color-muted)] leading-relaxed">Board-certified providers specializing in ophthalmology and surgical eye care, committed to delivering evidence-based patient education and compassionate care.</p>
          </div>
        </div>
      </div>
