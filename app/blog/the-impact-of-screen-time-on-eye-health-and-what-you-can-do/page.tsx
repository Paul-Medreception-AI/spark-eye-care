          ...
          <div className="bg-[var(--color-cream)] rounded-2xl p-8 flex gap-6 items-start animate-fade-up">
            ...
            <div>
              ...
              <p className="text-[var(--color-muted)] text-sm leading-relaxed">
                Board-certified providers specializing in ophthalmology and surgical eye care, committed to delivering compassionate, evidence-based care and empowering patients with knowledge about their eye health.
              </p>
            </div>
          </div>
        </div>
