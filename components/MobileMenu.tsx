        ...
        >
              ...
              {NAV_LINKS.map(link => (
                <li key={link.href}>
                  <a
                    ...
                    onClick={() => setOpen(false)}
                    className="block py-4 text-xl font-medium text-[var(--color-ink)] hover:text-[var(--color-primary)] transition-colors border-b border-[var(--color-border)]"
                  >
                    {link.label}
                  </a>
                </li>
          ...
          <div className="border-t border-[var(--color-border)] px-6 py-6 space-y-3 bg-white">
            ...
            <a
              href="/contact#form"
              onClick={() => setOpen(false)}
              className="flex items-center justify-center w-full py-3.5 rounded-xl bg-[var(--color-primary)] hover:bg-[var(--color-dark)] text-white font-semibold transition-colors"
            >
              Request Appointment
            </a>
          </div>
